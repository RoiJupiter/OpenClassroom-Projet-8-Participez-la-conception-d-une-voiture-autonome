...
def show_selected_image(filename):
    ...
    # Rend la page "show_selected_image.html" en passant les chemins des images sélectionnée et du masque
    return render_template('show_selected_image.html', selected_image_path=selected_image_path, mask_image_path=mask_image_path)
